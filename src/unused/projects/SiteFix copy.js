            ...
            <div>
                <div className='py-8 md:py-16 px-4'>
                    <div className='max-w-4xl mx-auto'>
                        ...
                        <div className='max-w-[1200px] mx-auto text-gray-700'>
                            ...
                            {/* <div className='mx-auto md:mx-0 py-4 md:py-0'>
                                <div className='max-h-[200px] hover:max-h-full max-w-[300px] overflow-hidden '>
                                    <a href='https://next.sitefix.ca' target='_blank'>
                                        <img src='/images/sitefix-3.png' className='-translate-y-[520px] hover:-translate-y-[0px] transition duration-[5000ms] hover:duration-[500ms]' />
                                    </a>
                                </div>
                            </div> */}
                        ...
                        <p className='mb-4 text-gray-700'>Admin dashboard created to manage the application. Full list of users, posts, and comments.</p>
                        <img src='/images/sitefix-admin.png' className='hover:scale-105 transition duration-500' />
                    </div>
                    <div className='mb-8 overflow-hidden'>
                        <h3 className='text-xl font-semibold mb-4'>Client Side Form Validation</h3>
                        <p className='mb-4 text-gray-700'>Collecting data from users can be messy, but with validation you can ensure clean responses.</p>
                        <img src='/images/sitefix-login.png' className='hover:scale-105 transition duration-500' />
                    </div>
                    <div className='mb-8 overflow-hidden'>
                        <h3 className='text-xl font-semibold mb-4'>Online Forum</h3>
                        <p className='mb-4 text-gray-700'>Users post questions and others can comment and share in a conversation.</p>
                        <img src='/images/sitefix-community.png' className='hover:scale-105 transition duration-500' />
                    </div> */}
                        {/* <div className='max-h-[300px] mt-8 overflow-hidden'>
                                <a href='http://sitefix.ca/' target="_blank">
                                <img src='/images/sitefix-1.png' className='shadow-md shadow-gray-800' />
