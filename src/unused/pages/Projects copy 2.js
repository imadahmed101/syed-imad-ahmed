        ...
        tech: 'React, Tailwind CSS, EmailJS',
                            ...
                            */}
                            <Link to='/projects/wmi'>
                                <img src='/images/wmi-tag.png' className='border-gray-300 border-[1px] rounded-md hover:border-black' />
                            </Link>
                        </div>
                        <div className='flex-1'>
                            <Link to='/projects/wmi'>
                            ...
                            <p className='text-white bg-blue-500 px-1.5 py-0.5 rounded font-semibold'>React</p>
                            <p className='text-white bg-purple-500 px-1.5 py-0.5 rounded font-semibold'>Tailwind CSS</p>
                            <p className='text-white bg-orange-500 px-1.5 py-0.5 rounded font-semibold'>EmailJS</p>

                                
                            </div>
                            <div>
                            <Link to='/projects/wmi' className='text-gray-700 font-semibold underline'>Learn More</Link>
                            </div>
                        </div>
                    </div>
