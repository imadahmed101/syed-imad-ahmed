...
const Services = () => {
  return (
    <div className='rounded-t-[50px] px-4 pt-8'>


      {/* <div className='bg-black text-white max-w-[1200px] p-8 rounded-[50px] mx-auto'> */}
      <div className='border-blue-400 border-[1px] text-black max-w-[1200px] p-8 rounded-[50px] mx-auto'>

        <h3 className='text-3xl pt-16 md:pt-8 pb-8'>Services</h3>

        <div className='flex flex-col md:flex-row justify-center gap-2 md:gap-8 pb-8'>
          <div className='border-blue-400 border-[1px] rounded-md py-16 w-[300px] text-center mx-auto md:mx-0'>
      ...
      <div className='text-black pt-40 pb-40 p-4 max-w-[1200px] mx-auto'>
        <motion.section
          variants=
          {containerVariant}
          initial='hidden'
          ...
          <div className='flex flex-col md:flex-row'>
            ...
            <div className='flex-1'>
              ...
              <div className=''>
                ...
                <p className='pb-16 text-lg'>Elevate Your Online Presence with Our Expert Website Services!</p>
      ...
      <div className='text-gray-700 pt-40 pb-40 p-4 max-w-[1200px] mx-auto'>
        <div className='flex flex-col md:flex-row'>
