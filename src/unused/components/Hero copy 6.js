    ...
    <div className=''>
      ...
      <div className='text-center text-black py-2 px-4 max-w-[1200px] mx-auto'>
          ...
          <motion.h2
            ...
            className=' text-3xl md:text-6xl pt-32 md:pt-32 px-4 flex justify-center text-gray-700'>Website Solutions For Your Business</motion.h2>
          <motion.p
            variants={itemVariant} className='text-sm md:text-xl pt-8 pb-16 md:pb-16'>Custom tailored to fit your requirements</motion.p>
...
{/*             
          ...
          <motion.div variants={itemVariant1} className='absolute top-0 -z-10 max-h-[600px] overflow-hidden'>
