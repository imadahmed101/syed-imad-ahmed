      ...
      >
        ...
        <div className='py-2 px-4 '>
          <div className='text-center text-black py-2 px-4 max-w-[1200px] mx-auto'>
            ...
            <motion.p
              variants={itemVariant} className='text-sm md:text-xl pt-8 pb-16 md:pb-60'>Custom tailored to fit your requirements</motion.p>

          </div>



          <motion.div variants={itemVariant} className='flex gap-4 flex-row justify-center'>
          ...
          <motion.div variants={itemVariant1} className='absolute top-0 -z-10 max-h-[760px] overflow-hidden'>
