    ...
    return (
        <div className=' '>
            ...
            <div className='flex justify-between bg-black rounded-full mt-4 text-white p-2 mx-4 px-2 md:px-4 md:mx-auto max-w-[1200px]'>
                ...
                <h1 className='p-2 font-semibold tracking-tight bg-[#084cab] rounded-full'><Link to='/' onClick={() => setOpen(false)}>Syed Imad Ahmed</Link></h1>
                <div className='hidden md:flex'>
                <Link to='/form' className='inline-flex font-semibold mr-4 text-white hover:text-blue-500 transition duration-500 p-2'>
                    Get Started
