...
const Navbar = () => {
    ...
    return (
        <div className=' sticky top-0 bg-white border-b-[1px] z-50 border-gray-300'>
            ...
            <div className='flex justify-between text-black py-2 px-4 max-w-[1200px] mx-auto'>
                ...
                <div className='hidden md:flex'>
                    ...
                    <a className='font-semibold text-black hover:text-blue-500 transition duration-500 p-2' href="/resume.pdf" target="_blank">Resume</a>
                </div>
