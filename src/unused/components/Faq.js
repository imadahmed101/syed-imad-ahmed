...
const Faq = () => {
  return (
    <div className='max-w-[1200px] mx-auto px-6 mb-16'>
        ...
        <p className='mb-4 text-gray-600'>If this is your very first website and you are unsure then the recommendation is to start with the starter package. This will give you a taste of what a website can do for your business. Includes a main page that can touch on different aspects of our business and convey that efficiently to your potential customers. In the future when you add more information and one page wont do then you can upgrade your account and have a multipage website.</p>
