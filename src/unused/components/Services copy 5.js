...
const Services = () => {
  return (
    <div className='bg-black rounded-t-[50px] px-4'>
      ...
      <div className='flex flex-col md:flex-row justify-center gap-2 md:gap-8'>
        <div className='border-gray-400 border-[1px] rounded-md py-16 w-[300px] text-center mx-auto md:mx-0'>
      ...
      <div className='text-gray-200 pt-40 pb-40 p-4 max-w-[1200px] mx-auto'>
        <motion.section
          variants=
          {containerVariant}
          initial='hidden'
...
<div>
      ...
      <div className='text-gray-700 pt-40 pb-40 p-4 max-w-[1200px] mx-auto'>
        <div className='flex flex-col md:flex-row'>
          ...
          <div className='flex-1 bg-white py-32 md:py-0'>
          </div>
