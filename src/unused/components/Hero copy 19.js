...
const Hero = () => {
  return (
    ...
    <div className='pt-2 pb-2 md:mb-8 px-4 overflow-hidden'>
      <div className='flex flex-col md:flex-row text-black py-2 px-4 max-w-[1200px] mx-auto'>
        <div className='max-w-[600px] mr-8'>
          ...
          <Link to='/form' className='inline-flex text-lg md:text-xl font-semibold bg-[#084cab] hover:bg-blue-700 text-white rounded-full py-2 px-4'>
            Get Started
      ...
      <div className='max-w-[600px]'>
        ...
        <img src='images/hero-img.jpg' className='max-w-[375px] md:max-w-[575px] translate-y-8 rounded-xl mt-8 md:mt-32 ml-4 md:ml-8' />
        </div>
      </div>
      </div>
