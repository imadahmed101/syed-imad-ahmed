  ...
  return (
    <div className='px-4 '>
      ...
      <div className='text-black pt-20 md:pb-20 p-4 max-w-[1200px] mx-auto'>
        ...
        >
          <div>
            <h3 className='text-3xl pb-4 bg-yellow-300'>Upgrading or Creating</h3>
      ...
      <div className='text-gray-700 pt-20 md:pb-20 p-4 max-w-[1200px] mx-auto'>
        <motion.div
          ...
          <div className='flex-1 md:pl-12'>
            <h3 className='text-4xl pb-4 bg-yellow-300'>Custom Design</h3>
      ...
      <div className='text-gray-700 pt-20 pb-20 p-4 max-w-[1200px] mx-auto'>
        <motion.div
          ...
          <div className='flex-1 md:mr-12'>
            <h3 className='text-4xl pb-4 bg-yellow-300'>Full Service</h3>
