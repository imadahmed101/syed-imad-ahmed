            ...
            <motion.div
                ...
                <div className='flex flex-row flex-wrap'>
                    ...
                    <div className='text-black pb-8 md:p-6 rounded-md max-w-[575px] mx-auto md:mx-0'>
                        ...
                        <h4 className='font-semibold text-lg mb-2 bg-yellow-300 max-w-[200px]'>Website Creation</h4>
                    ...
                    <div className='text-black pb-8 md:p-6 rounded-md max-w-[575px] mx-auto md:mx-0'>
                        ...
                        <h4 className='font-semibold text-lg mb-2 bg-yellow-300 max-w-[200px]'>Website Design</h4>
                    ...
                    <div className='text-black pb-8 md:p-6 rounded-md max-w-[575px] mx-auto md:mx-0'>
                        ...
                        <h4 className='font-semibold text-lg mb-2 bg-yellow-300 max-w-[200px]'>Website Hosting</h4>
                    ...
                    <div className='text-black pb-8 md:p-6 rounded-md max-w-[575px] mx-auto md:mx-0'>
                        ...
                        <h4 className='font-semibold text-lg mb-2 bg-yellow-300 max-w-[200px]'>Domain Registration</h4>
                    ...
                    <div className='text-black pb-8 md:p-6 rounded-md max-w-[575px] mx-auto md:mx-0'>
                        ...
                        <h4 className='font-semibold text-lg mb-2 bg-yellow-300 max-w-[200px]'>Email Configuration</h4>
                    ...
                    <div className='text-black pb-8 md:p-6 rounded-md max-w-[575px] mx-auto md:mx-0'>
                        ...
                        <h4 className='font-semibold text-lg mb-2 bg-yellow-300 max-w-[200px]'>Copy Writing</h4>
