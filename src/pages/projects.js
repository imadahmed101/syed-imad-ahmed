  ...
  return (
    <div className={projectsPage}>
      ...
      <div>
          ...
          <p>Spiceez</p>
          <ModalID />
          <Link to='http://54.235.13.47:3000' target="_blank"><Button variant="outline-dark" style={{ marginRight: "10px" }}>Live Site</Button></Link>
        ...
        <div>
          ...
          <p>CashPhone.ca</p>
          <ModalCP />
          <Link to="http://cash-phone.s3-website-us-east-1.amazonaws.com/" target="_blank"><Button variant="outline-dark" style={{ marginRight: "10px" }}>Live Site</Button></Link>
