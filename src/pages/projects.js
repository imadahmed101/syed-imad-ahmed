  ...
  return (
    <div className={projectsPage}>
      ...
      <div>
          ...
          <p>Spiceez</p>
          <ModalID />
          <Link to='http://54.235.13.47:3000' target="_blank"><Button variant="outline-light" style={{ marginRight: "10px" }}>Live Site</Button></Link>
        ...
        <div>
          ...
          <p>Cash Phone</p>
          <ModalCP />
          <Link to="http://cash-phone.s3-website-us-east-1.amazonaws.com/" target="_blank"><Button variant="outline-light" style={{ marginRight: "10px" }}>Live Site</Button></Link>
          <Link to="https://github.com/imadahmed101/cash-phone" target="_blank"><Button variant="outline-light">Github</Button></Link>
        </div>
        <div>
          <h3>Company Site</h3>
        ...
        <div>
          ...
          <ModalSIA />
          <Link to="https://syedimadahmed.com" target="_blank"><Button variant="outline-light" style={{ marginRight: "10px" }}>Live Site</Button></Link>
          <Link to="https://github.com/imadahmed101/syed-imad-ahmed" target="_blank"><Button variant="outline-light">Github</Button></Link>
        </div>
      </div>
    </div>
  )
