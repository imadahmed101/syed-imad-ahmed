                ...
                <div className='max-w-4xl mx-auto'>
                    ...
                    <div className='mt-8 overflow-hidden'>
                        ...
                        <div className='pt-4'>
                            ...
                            <a className='border-2 border-white text-white text-lg rounded-md px-4 py-2 hover:bg-black transition duration-500 mr-2' href='https://azure-test-3-imadahmed101.azurewebsites.net/' target="_blank">Live</a>
                            <a className='border-2 border-white text-white text-lg rounded-md px-4 py-2 hover:bg-black transition duration-500' href='https://github.com/imadahmed101/azure-test-3' target="_blank">GitHub</a>
