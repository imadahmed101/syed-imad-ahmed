      ...
      <form onSubmit={formik.handleSubmit} className='max-w-[500px] py-4 px-2 md:px-8 mx-auto'>
        ...
        <div className='flex flex-row text-center justify-between text-gray-400 mb-8'>
          ...
          {!businessInfo ?
            ...
            :
            <button type='button' onClick={() => {setBusinessInfo(false); setServicesInfo(false)}}>
              <p>1</p>
              <p>Business Info</p>
            </button>
          }
          ...
          {businessInfo && !servicesInfo ?
            ...
            :
            <button type='button' onClick={() => {setBusinessInfo(true); setServicesInfo(false)}}>
              <p>2</p>
              <p>Services Info</p>
            </button>
          }
          ...
          {businessInfo && servicesInfo && !personalInfo ?
            ...
            :
            <button type='button' onClick={() => {setBusinessInfo(true); setServicesInfo(true)}}>
              <p>3</p>
              <p>Personal Info</p>
            </button>
          }
        ...
        {businessInfo && servicesInfo && !personalInfo &&
          <div>
            ...
            <div className='flex flex-row justify-between'>
              ...
              <div className=''>
                <button type='submit' className='bg-black p-2 rounded-full text-white hover:bg-white hover:text-black'>Submit</button>
              </div>
